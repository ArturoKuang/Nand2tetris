...
class JackAnalyzer(inputFileName: String) {
...
//        println("$currentCharNum: $currentChar")
        when {
...
fun main() {
    val jackAnalyzer = JackAnalyzer("/Users/arturokuang/Downloads/nand2tetris/projects/10/Square/Square.jack")
